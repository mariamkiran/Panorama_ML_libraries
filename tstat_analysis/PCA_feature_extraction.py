...
label_file = os.path.join("../rawdata/fullfeaturedata-windows.csv")
...
#extracting features
features = ['Average rtt C2S', 'Average rtt S2C','max seg size1','min seg size1','win max1','win min1','win zero1','cwin max1','cwin min1','initial cwin1','rtx RTO1','rtx FR1','reordering1','net dup1','max seg size','in seg size','win max','win min','win zero','cwin max','cwin min','initial cwin','rtx RTO','rtx FR','eordering','net dup']
...
targets = ['normal', 'no-flow', 'loss-1%', 'loss-5%', 'duplicate-1%', 'duplicate-5%','reordering25%-50%','reordering50%-50%']
